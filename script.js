...
document.querySelector('.nav__links').addEventListener('click', function(e) {
  ...
  //Matching strategy -ignores clicks that didn't happen directly on the links
...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  rootMargin: `-${navHeight}px` //Makes the sticky nav pop up when the gap before the section is equal to the nav height
});
...
const revealSection = function(entries, observer) {
  ...
  observer.unobserve(entry.target); //Keeps the observer entries from being logged in the console
};
...
document.querySelector('.nav__link').addEventListener('click', function (e) {
  ...
  //Stop propagation
  //e.stopPropagation(); //Be careful using this
});
